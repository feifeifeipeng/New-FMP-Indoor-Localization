...
# -*- coding: utf-8 -*-
##
# @file     simo_hybrid_uji.py
# @author   Kyeong Soo (Joseph) Kim <kyeongsoo.kim@gmail.com>
# @date     2019-02-15
#
# @brief A scalable indoor localization system based on Wi-Fi fingerprinting
#        using multi-class classification of building and floor and regression
#        of location coordiates with a single-input and multi-output (SIMO)
#        deep neural network (DNN) model and UJIIndoorLoc datasets.
#
# @remarks The results are to be published in the special issue of
#          <a href="http://www.ijnc.org/">International Journal of Networking
#          and Computing</a>.
...
if __name__ == "__main__":
    ...
    ### run simo_hybrid_uji() num_runs times
    ...
    for i in range(num_runs):
        ...
        rst = simo_hybrid_uji(gpu_id, dataset, frac, validation_split,
