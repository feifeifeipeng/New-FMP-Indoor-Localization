...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset",
        help="a data set for training, validation, and testing; choice is 'uji' (default)",
        default='uji',
        type=str)
    parser.add_argument(
        "-F",
    ...
    for i in range(num_runs):
        ...
        rst = siso_regression_uji(gpu_id, dataset, frac, validation_split,
